        ...
        <div className="max-w-[1200px] mx-auto px-8 flex flex-col gap-12 items-center md:flex-row-reverse">
          <div className="flex-1 min-w-0">
            ...
            <AnimatedSection direction="right" delay={0.2}>
              ...
              >
                Мы предлагаем два варианта реализации видеосистемы. В о��оих случаях создается не один ролик, а набор видео, демонстрирующих оборудование компании в технологичной и понятной форме — с фокусом на продукте, принципе работы и ключевых преимуществах.
              </p>
            </AnimatedSection>
          </div>
          <AnimatedSection className="flex-1 min-w-0 w-full" direction="left" delay={0.3}>
